 ...
 * @example
 * wortalTournamentGetCurrentAsync()
 * .then(tournament => {
 ...
 * <li>NOT_SUPPORTED</li>
 */
function wortalTournamentGetCurrentAsync() {
 ...
 * <li>NOT_SUPPORTED</li>
 */
function wortalTournamentGetAllAsync() {
 ...
 * </ul>
 */
function wortalTournamentPostScoreAsync(score) {
 ...
 * </ul>
 */
function wortalTournamentCreateAsync(payload) {
 ...
 * <li>NOT_SUPPORTED</li>
 */
function wortalTournamentShareAsync(payload) {
 ...
 * @example
 * wortalTournamentJoinAsync("1234567890")
 ...
 * <li>NOT_SUPPORTED</li>
 */
function wortalTournamentJoinAsync(tournamentID) {
